 ...
 */
@Entity
@Table(name = "SDL_CANTONINTERVENTIONS")
...
public class SdlCantonIntervention extends CantonIntervention {
    private Blob plausireportDe;
    private Blob plausireportFr;
    private Blob plausireportIt;

    /** Default constructor */
    public SdlCantonIntervention() {}

    /** Copy from dto */
    public SdlCantonIntervention(CantonIntervention dtoIntervention) {
