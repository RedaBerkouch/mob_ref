...
public class ConcludePlausiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution arg0, ChunkContext arg1) throws Exception {
        ...
        ExternalPlausiProcess externalPlausiProcess = _plausiFactory.createExternalPlausiProcess(CodegroupUtility.SDL_OBJECTTYPE_DELIVERY,
                delivery.getVersion());
        DeliveryBO deliveryBO = new DeliveryBO(delivery, _schoolRepository, _classRepository, _learnerRepository);
        ...
        SdlIntervention intervention = _interventionRepository.getInterventionById(_interventionId);
