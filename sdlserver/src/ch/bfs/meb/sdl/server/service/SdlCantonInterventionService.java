...
@WebService(serviceName = "SdlCantonInterventionWebService", name = "SdlCantonInterventionWebServicePortType")
public class SdlCantonInterventionService extends AbstractMebWebService<ICantonInterventionService> {
    @WebMethod
