...
@WebService(serviceName = "SdlConfigDeliveryWebService", name = "SdlConfigDeliveryWebServicePortType")
public class SdlConfigDeliveryService extends AbstractMebWebService<IConfigDeliveryService> {
    @WebMethod
