...
@WebService(serviceName = "SdlBurSchoolWebService", name = "SdlBurSchoolWebServicePortType")
public class SdlBurSchoolService extends AbstractMebWebService<IBurSchoolService> {
    @WebMethod
