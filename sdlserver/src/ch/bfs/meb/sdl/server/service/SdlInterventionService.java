...
@WebService(serviceName = "SdlInterventionWebService", name = "SdlInterventionWebServicePortType")
public class SdlInterventionService extends AbstractMebWebService<IInterventionService> {
    @WebMethod
