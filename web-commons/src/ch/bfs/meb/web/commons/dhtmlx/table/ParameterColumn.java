...
public class ParameterColumn extends Column {
     ...
     */
    protected final HashMap<String, WebParameter> _paramMap = new HashMap<String, WebParameter>();
     ...
     */
    public ParameterColumn(String name, String header, String rowIdName, IWebLocalizationManager manager) throws DhtmlxException {
    ...
    public Object toValue(Object raw) throws OgnlException {
        ...
        if (values != null) {
            ...
            for (int i = 0; i < values.size(); ++i) {
                WebParameter param = (WebParameter) values.get(i);
    ...
    public void toObject(Object object, Object value) throws DhtmlxException {
        try {
            ArrayList<WebParameter> params = new ArrayList<WebParameter>();
            WebParameter param;
    ...
    private List<WebParameter> sort(List<WebParameter> values) {
        Collections.sort(values, new Comparator<WebParameter>() {
            @Override
            public int compare(WebParameter o1, WebParameter o2) {
