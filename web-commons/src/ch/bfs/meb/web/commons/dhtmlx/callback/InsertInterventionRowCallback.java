/*
  ...
  $Id: InsertInterventionRowCallback.java 1386 2010-04-22 12:37:33Z jfu $
 ...
 */
public class InsertInterventionRowCallback extends MasterDetailCallbackBase {
    public enum Master {
    ...
    public InsertInterventionRowCallback(IDhtmlxManager manager) {
        this(manager, null, null, Master.ALWAYS, null, null);
    }

    public InsertInterventionRowCallback(IDhtmlxManager manager, IDhtmlxControl other, IGlobalJavaScript globals) {
        this(manager, other, null, Master.ALWAYS, globals, null);
    }

    public InsertInterventionRowCallback(IDhtmlxManager manager, IDhtmlxControl other, IDhtmlxControl third, IGlobalJavaScript globals) {
        this(manager, other, third, Master.ALWAYS, globals, null);
    }

    public InsertInterventionRowCallback(IDhtmlxManager manager, Master master, IGlobalJavaScript globals, String message) {
        this(manager, null, null, master, globals, message);
    }

    public InsertInterventionRowCallback(IDhtmlxManager manager, IDhtmlxControl other, Master master, IGlobalJavaScript globals, String message) {
        this(manager, other, null, master, globals, message);
    }

    public InsertInterventionRowCallback(IDhtmlxManager manager, IDhtmlxControl other, IDhtmlxControl third, Master master, IGlobalJavaScript globals,
            String message) {
    ...
    public String getScriptingBody() throws DhtmlxException {
        ...
        // Add row
        table.addRow(_index, getDefaults(), JSNumber.byVal(0));
