========================================================================================================================
MEB version 02.44.14
========================================================================================================================
Auteur: Sword
Date:
  REFERENZ (REF)    :  11.07.2024
  ABNAHME (ABN)     :  TBD
  PRODUKTION (PROD) :  TBD
...
Évolutions :
	...
	* #96 :  MEB-SBG - La plage servant à visualiser le nom du fichier est plus large afin de voir le texte en entier ; checked
	* #97 :  MEB-SBG - Les champs USERCOMMENT peuvent contenir jusqu'à 1024 caractères et le front-end est adapté en conséquence ; checked
...
------------------------------
REF (Changements de v02.44.11 à v02.44.14) :
- App :     Pas de changement
- WSDL :    Pas de changement
- DB :      Script MEB-97_SBG_Update_Schema
- Conf :    -

ABN (Changements de v02.44.11 à v02.44.14) :
- App :     Pas de changement.
- WSDL :    Pas de changement.
- DB :      Pas de changement.
- Conf :    -

PROD (Changements de v02.44.11 à v02.44.14) :
- App :     Pas de changement.
- WSDL :    Pas de changement.
- DB :      Pas de changement.
- Conf :    -