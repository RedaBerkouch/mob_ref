...
- MEB-125 Upload-Dialog soll per default einen Filter für CSV-Files eingestellt haben
  dieses Ticket wurde am 2020-12-11 mit Version v02.42.06 unter geändertem Titel nochmal deployt:
...
--------------------------
REFERENZUMGEBUNG (Wechsel von v02.42.04 auf v02.42.05):
- App:	via UCD
- WSDL:	Keine Änderung
- DB:	Keine Änderung.
- Conf: Durch adesso verwaltet.

ABNAHME (kein Release mit dieser Version):
- App:	via UCD
- WSDL:	Keine Änderung.
- DB:	Keine Änderung.
- Conf: keine Änderung.
