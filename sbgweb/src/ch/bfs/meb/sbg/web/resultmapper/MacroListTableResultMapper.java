 ...
 */
public class MacroListTableResultMapper extends ListResultMapperBase {
    /**
     * @param result
     * @throws DhtmlxException
     */
    public MacroListTableResultMapper(MacroList result, IWebLocalizationManager languageManager) throws DhtmlxException {
        super(result, languageManager);
    }

    @Override
    public List<Macro> getData() {
        return ((MacroList) getResult()).getMacros();
    }
}