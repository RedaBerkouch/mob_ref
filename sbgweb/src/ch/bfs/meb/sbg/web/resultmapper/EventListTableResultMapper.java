 ...
 */
public class EventListTableResultMapper extends ListResultMapperBase {
    /**
     * @param result
     * @throws DhtmlxException
     */
    public EventListTableResultMapper(EventList result, IWebLocalizationManager languageManager, Long resultSize, Integer position) throws DhtmlxException {
        super(result, languageManager, resultSize != null ? resultSize.intValue() : null, position);
    }

    @Override
    public List<Event> getData() {
        return ((EventList) getResult()).getEvents();
    }
}