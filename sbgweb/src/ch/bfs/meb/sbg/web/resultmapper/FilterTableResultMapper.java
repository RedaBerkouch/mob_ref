 ...
 * 
 * $Id: FilterTableResultMapper.java 300 2007-08-30 14:20:29Z dzw $
 *
 * ------------------------------------------------------------------------- */
...
public class FilterTableResultMapper extends SingleResultMapperBase {
     ...
     */
    public FilterTableResultMapper(String command, String originalId, WebFilterResult result, IWebLocalizationManager localizationManager)
            throws DhtmlxException {
