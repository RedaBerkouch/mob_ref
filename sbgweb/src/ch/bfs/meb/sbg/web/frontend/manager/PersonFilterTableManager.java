 ...
 * 
 * $Id: PersonFilterTableManager.java 364 2007-09-18 13:16:34Z dzw $
 *
 * ------------------------------------------------------------------------- */
 ...
 */
@Scope("session")
@Component("personFilterTableManager")
public class PersonFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(PersonFilterTableManager.class);

    public static final String MANAGER_NAME = "personFilter";
    ...
    public WebFilterListResult getAllRows() {
        return _filterService.getFiltersForRefObject(CodegroupUtility.SBG_OBJECTTYPE_PERSON);
    }
}
