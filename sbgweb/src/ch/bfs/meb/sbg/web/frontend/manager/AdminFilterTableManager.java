 ...
 * 
 * $Id: AdminFilterTableManager.java 632 2010-11-22 10:10:15Z msc $
 *
 * ------------------------------------------------------------------------- */
...
import ch.bfs.meb.sbg.web.resultmapper.FilterListTableResultMapper;
import ch.bfs.meb.sbg.web.resultmapper.FilterTableResultMapper;
...
public class AdminFilterTableManager extends TableManagerBase {
    ...
    private static final Log LOGGER = LogFactory.getLog(AdminFilterTableManager.class);
     ...
     */
    public WebFilterListResult getRows() {
    ...
    public DhtmlxTableDataXML undo(ParameterList params) throws DhtmlxException {
        ...
        if (!params.getEditorStatus().equals(EDIT.INSERT)) {
            ...
            // Maps result
            WebFilterResult result = new WebFilterResult();
            result.setState(1);
            result.setFilter(new WebFilter());
