...
function evaluateActionForHistory(
	...
	switch (actionType) {
		...
		case 'delete':
			return isDeleteDisabled(type, hasDL);
 ...
 * Actif uniquement pour les interventions MANUAL avec rôle DL
 */
function isDeleteDisabled(type: number | undefined, hasDL: boolean): boolean {
	...
	return type !== MEB_INTERVENTIONTYPE.MANUAL; // Actif uniquement si MANUAL
}
