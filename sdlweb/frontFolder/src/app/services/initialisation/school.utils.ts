 ...
 *  — elle n'est pas référencée dans SDL (burIsSdl = false), OU
...
export function shouldDeleteOnGetBur(school: School, version: number): boolean {
	return (
		...
		(school.burValidFromSdlSsp != null && school.burValidFromSdlSsp > version) ||
		(school.burValidToSdlSsp != null && school.burValidToSdlSsp < version)
	);
}
