...
export class UserService {
	private readonly baseUrl = '/sdlweb/api/user';
	...
	readonly canAccessSchoolDelivery = computed(
	...
	readonly canAccessCantonOrganisation = computed(() => this.isDV() || this.isEV() || this.isEA());
	readonly canAccessAdministration = computed(() => this.isEA());

	readonly canEditCantonOrganisation = computed(() => this.isEV() || this.isEA());
