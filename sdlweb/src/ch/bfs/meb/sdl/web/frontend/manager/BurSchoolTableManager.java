...
import ch.bfs.meb.sdl.web.frontend.resultmapper.BurSchoolListTableResultMapper;
import ch.bfs.meb.sdl.web.frontend.resultmapper.BurSchoolTableResultMapper;
...
/**
 * This Class represents a ConfigDeliveryTableManager for the maintain tab and acts
...
public class BurSchoolTableManager extends FilteredTableManagerBase {
    ...
    public BurSchoolTableManager() throws DhtmlxException {
        super();
    }
    ...
    public void create() throws DhtmlxException {
        ...
        Column codeColumn = new CodeColumn(COLUMN_CANTON_ID, COLUMN_CANTON_NAME_KEY, getLocalizationManager(), CodegroupUtility.CANTON, 3);
        ...
        addColumn(codeColumn);
        addColumn(new ReadOnlyColumn(COLUMN_NAME_BUR_ID, COLUMN_NAME_BUR_NAME_KEY, getLocalizationManager(), 8));
        ...
        codeColumn = new CodeColumn(COLUMN_CANTON_BUR_ID, COLUMN_CANTON_BUR_NAME_KEY, getLocalizationManager(), CodegroupUtility.CANTON, 5);
        addColumn(codeColumn);

        codeColumn = new MunicipalityCodeColumn(COLUMN_MUNICIPALITY_BUR_ID, COLUMN_MUNICIPALITY_BUR_NAME_KEY, getLocalizationManager(),
                CodegroupUtility.MUNICIPALITY, 9);
        addColumn(codeColumn);
        ...
        if (!user.isRoleErhebung(MebDomain.SDL)) {
    ...
    public Map<String, String> getRowUserData(Object row) {
        ...
        // COLUMN_CANTON, COLUMN_BURNR, COLUMN_LABEL
        // IS_PUBLIC_SCHOOL, IS_PRIVATE_SUBSIDISED_SCHOOL, IS_PRIVATE_NOT_SUBSIDISED_SCHOOL, IS_SPECIAL_SCHOOL,
        // COLUMN_DELIVERY
        // COLUMN_MUNICIPALITY, COLUMN_SYNCHSTATUSBUR, COLUMN_NAME_BUR
        // COLUMN_CANTON_BUR, COLUMN_MUNICIPALITY, COLUMN_VALIDFROM_BUR
        // COLUMN_VALIDTO_BUR
        ...
        boolean toDelete = !burSchool.isBurIsSdl() || burSchool.getBurActivityStatus() == CodegroupUtility.MEB_BUR_ACTIVITY_STATUS_DELETED
                ...
                || (burSchool.getBurValidFromSdlSsp() != null && burSchool.getBurValidFromSdlSsp() > version)
                || (burSchool.getBurValidToSdlSsp() != null && burSchool.getBurValidToSdlSsp() < version);
