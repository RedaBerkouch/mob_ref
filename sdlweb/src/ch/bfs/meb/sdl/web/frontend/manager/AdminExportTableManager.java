...
import ch.bfs.meb.sdl.web.frontend.resultmapper.ExportListTableResultMapper;
import ch.bfs.meb.sdl.web.frontend.resultmapper.ExportTableResultMapper;
import ch.bfs.meb.sdl.web.service.IExportService;
...
/**
 * This Class represents a ExportTableManager for the admin tab and acts as a
 * controller for the Export Table.
 */
@Scope("session")
@Component("adminExportTableManager")
public class AdminExportTableManager extends TableManagerBase {
    @SuppressWarnings("unused")
    private final static Logger LOGGER = LoggerFactory.getLogger(AdminExportTableManager.class);

    public static final String COLUMN_EXPORT_ID = "exportId";
    public static final String COLUMN_EXPORT_NAME_KEY = "adminExportTable.column.id.name";
    public static final String COLUMN_SORT_ORDER_ID = "exportOrder";
    public static final String COLUMN_SORT_ORDER_NAME_KEY = "adminExportTable.column.order.name";
    public static final String COLUMN_NAME_DE_ID = "nameDe";
    public static final String COLUMN_NAME_DE_NAME_KEY = "adminExportTable.column.name.german.name";
    public static final String COLUMN_NAME_FR_ID = "nameFr";
    public static final String COLUMN_NAME_FR_NAME_KEY = "adminExportTable.column.name.french.name";
    public static final String COLUMN_NAME_IT_ID = "nameIt";
    public static final String COLUMN_NAME_IT_NAME_KEY = "adminExportTable.column.name.italian.name";
    public static final String COLUMN_TYPE_ID = "type";
    public static final String COLUMN_TYPE_NAME_KEY = "adminExportTable.column.type.name";
    public static final String COLUMN_AUTHORISATION_ID = "authorisationLevel";
    public static final String COLUMN_AUTHORISATION_NAME_KEY = "adminExportTable.column.authorisation.name";
    public static final String COLUMN_ACTIVE_ID = "isActive";
    public static final String COLUMN_ACTIVE_NAME_KEY = "adminExportTable.column.active.name";
    public static final String COLUMN_DESCRIPTION_DE_ID = "descriptionDe";
    public static final String COLUMN_DESCRIPTION_DE_NAME_KEY = "adminExportTable.column.description.german.name";
    public static final String COLUMN_DESCRIPTION_FR_ID = "descriptionFr";
    public static final String COLUMN_DESCRIPTION_FR_NAME_KEY = "adminExportTable.column.description.french.name";
    public static final String COLUMN_DESCRIPTION_IT_ID = "descriptionIt";
    public static final String COLUMN_DESCRIPTION_IT_NAME_KEY = "adminExportTable.column.description.italian.name";
    public static final String COLUMN_SOURCE_ID = "source";
    public static final String COLUMN_SOURCE_NAME_KEY = "adminExportTable.column.source.name";

    public static final String MANAGER_NAME = "adminExport";
    ...
    private IDhtmlxControl getParameterTable() {
        return new IDhtmlxControl() {
            ...
            public String getControlName() {
                return ExportParamTableManager.CONTROL_NAME;
            }

            @Override
            public String getName() {
                return ExportParamTableManager.MANAGER_NAME;
            }
        };
    }
    ...
    /**
     * Initializes a new AdminExportTableManager. This is a callback interface.
    ...
    public void create() throws DhtmlxException {
        ...
        ComboCodeGroupColumn typeColumn = new ComboCodeGroupColumn(COLUMN_TYPE_ID, COLUMN_TYPE_NAME_KEY, getLocalizationManager(), "MEB_EXPORTTYPE", 6);
        // sort bei code not text ok 
        // typeColumn.setSort(SORT.NO_SORT);
        addColumn(typeColumn);

        ComboCodeGroupColumn authColumn = new ComboCodeGroupColumn(COLUMN_AUTHORISATION_ID, COLUMN_AUTHORISATION_NAME_KEY, getLocalizationManager(), "MEB_ROLE",
                6);
    ...
    private ExportListResult getRows() {
        ...
        return _exportService.getExports();
    }
    ...
    public DhtmlxTableDataXML update(ParameterList params) throws DhtmlxException, OgnlException {
        ...
        Export export = (Export) merge(params);

        ExportResult result = _exportService.updateExport(export);

        // Maps result
        ExportTableResultMapper resultMapper = new ExportTableResultMapper(CommandConstants.UPDATE, sid, result, getLocalizationManager());
    ...
    public DhtmlxTableDataXML delete(ParameterList params) throws DhtmlxException, OgnlException {
        ...
        ExportResult result = _exportService.deleteExport(export);
    ...
    public DhtmlxTableDataXML insert(ParameterList params) throws DhtmlxException, OgnlException {
        ...
        Export export = (Export) merge(new Export(), params);

        ExportResult result = _exportService.insertExport(export);

        // Maps result
        ExportTableResultMapper resultMapper = new ExportTableResultMapper(CommandConstants.INSERT, sid, result, getLocalizationManager());
