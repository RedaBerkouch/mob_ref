...
@Scope("session")
@Component("classFilterTableManager")
public class ClassFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(ClassFilterTableManager.class);

    public static final String MANAGER_NAME = "classFilter";
    ...
    public WebFilterListResult getAllRows() {
        ...
        return _filterService.getFiltersForRefObject(CodegroupUtility.SDL_OBJECTTYPE_CLASS);
    }
}
