...
import ch.bfs.meb.sdl.web.frontend.resultmapper.ConfigDeliveryListTableResultMapper;
import ch.bfs.meb.sdl.web.frontend.resultmapper.ConfigDeliveryTableResultMapper;
import ch.bfs.meb.sdl.web.service.ICantonService;
import ch.bfs.meb.sdl.web.service.IConfigDeliveryService;
...
public class ConfigDeliveryTableManager extends FilteredTableManagerBase {
    ...
    public void create() throws DhtmlxException {
        ...
        setFilterVersion(FilterContextUtility.getInitVersion(_filterService, CodegroupUtility.SDL_OBJECTTYPE_CONFIGURATION));
        ...
        IJavaScriptFunction refreshButtonsCallback = new RefreshConfigDeliveryButtonsCallback(this, !user.isRoleErhebung(MebDomain.SDL));
