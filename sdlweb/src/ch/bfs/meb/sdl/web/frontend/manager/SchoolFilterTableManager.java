...
@Scope("session")
@Component("schoolFilterTableManager")
public class SchoolFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(SchoolFilterTableManager.class);

    public static final String MANAGER_NAME = "schoolFilter";
    ...
    public WebFilterListResult getAllRows() {
        ...
        return _filterService.getFiltersForRefObject(CodegroupUtility.SDL_OBJECTTYPE_SCHOOL);
    }
}
