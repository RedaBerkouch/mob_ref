...
@Scope("session")
@Component("learnerFilterTableManager")
public class LearnerFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(LearnerFilterTableManager.class);

    public static final String MANAGER_NAME = "learnerFilter";
    ...
    public WebFilterListResult getAllRows() {
        ...
        return _filterService.getFiltersForRefObject(CodegroupUtility.SDL_OBJECTTYPE_LEARNER);
    }
}
