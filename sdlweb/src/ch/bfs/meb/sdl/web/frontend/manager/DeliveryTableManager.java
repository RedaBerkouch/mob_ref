...
import ch.bfs.meb.sdl.web.dhtmlx.callback.RefreshDeliveryButtonsCallback;
import ch.bfs.meb.sdl.web.frontend.resultmapper.DeliveryListTableResultMapper;
import ch.bfs.meb.sdl.web.frontend.resultmapper.DeliveryTableResultMapper;
import ch.bfs.meb.sdl.web.service.ICantonService;
import ch.bfs.meb.sdl.web.service.IDeliveryService;
...
public class DeliveryTableManager extends FilteredTableManagerBase implements PlausiErrorColumn.IPlausiErrorDataUpdate {
    ...
    public static final String COLUMN_PLAUSISCHOOL_ID = "nrPlausiSchool";
    public static final String COLUMN_PLAUSISCHOOL_NAME_KEY = "deliveryTable.column.plausischool.name";
    public static final String COLUMN_PLAUSICLASS_ID = "nrPlausiClass";
    public static final String COLUMN_PLAUSICLASS_NAME_KEY = "deliveryTable.column.plausiclass.name";
    public static final String COLUMN_PLAUSILEARNER_ID = "nrPlausiLearner";
    ...
    public void create() throws DhtmlxException {
        ...
        if (user.getLastFilterVersion() == null) {
            setFilterVersion(FilterContextUtility.getActVersion(_filterService, CodegroupUtility.SDL_OBJECTTYPE_CONFIGURATION));
        ...
        addColumn(new ReadOnlyColumn(COLUMN_CODE_ID, COLUMN_CODE_NAME_KEY, getLocalizationManager(), 7));

        CodeColumn cantonColumn = new CodeColumn(COLUMN_CANTON_ID, COLUMN_CANTON_NAME_KEY, getLocalizationManager(), CodegroupUtility.CANTON, 3);
        addColumn(cantonColumn);

        addColumn(new ReadOnlyColumn(COLUMN_VERSION_ID, COLUMN_VERSION_NAME_KEY, getLocalizationManager(), 4));

        Column statusColumn = new StatusColumn(COLUMN_STATUS_ID, COLUMN_STATUS_NAME_KEY, getLocalizationManager(), CodegroupUtility.MEB_DELIVERYSTATUS, 20);
        ...
        Column plausiColumn = new PlausistatusColumn(COLUMN_PLAUSISTATUS_ID, COLUMN_PLAUSISTATUS_NAME_KEY, getLocalizationManager(), 14);
        ...
        deliveryDateColumn.setWidth(5);
        addColumn(deliveryDateColumn);

        addColumn(new ReadOnlyColumn(COLUMN_DELIVERYUSER_ID, COLUMN_DELIVERYUSER_NAME_KEY, getLocalizationManager(), 25));

        addColumn(new ReadOnlyColumn(COLUMN_PLAUSISCHOOL_ID, COLUMN_PLAUSISCHOOL_NAME_KEY, false, true, getLocalizationManager(), 8));
        addColumn(new ReadOnlyColumn(COLUMN_PLAUSICLASS_ID, COLUMN_PLAUSICLASS_NAME_KEY, false, true, getLocalizationManager(), 8));
        addColumn(new ReadOnlyColumn(COLUMN_PLAUSILEARNER_ID, COLUMN_PLAUSILEARNER_NAME_KEY, false, true, getLocalizationManager(), 8));
        ...
        IJavaScriptFunction onCellChangedCallback = new ReplaceDataCallback(this, COLUMN_PLAUSISCHOOL_ID);
        OnColumnSortCallback onColumnSortCallback = new OnColumnSortCallback(this, getInterventionTable(), _maintainglobals);

        onColumnSortCallback.addIgnoreColumn(getColumnIndexById(COLUMN_PLAUSISCHOOL_ID));
        onColumnSortCallback.addIgnoreColumn(getColumnIndexById(COLUMN_PLAUSICLASS_ID));
        onColumnSortCallback.addIgnoreColumn(getColumnIndexById(COLUMN_PLAUSILEARNER_ID));
        ...
        registerCallback(new ShowReplaceDataCallback(this, COLUMN_PLAUSISCHOOL_ID, COLUMN_PLAUSICLASS_ID, COLUMN_PLAUSILEARNER_ID));
        ...
        registerCallback(new ValidateDeliveryCallback(this, CodegroupUtility.MEB_APPLICATION_SDL));
        ...
        registerCallback(new DeleteDeliveryCallback(this, COLUMN_STATUS_ID, CodegroupUtility.MEB_APPLICATION_SDL));
    ...
    protected Long getDeliveryId(String selected) {
        return ((SdlDelivery) getRowData(selected)).getDeliveryId();
    }
     ...
     *         rows
     */
    public SdlDeliveryListResult getRows(int start, int buffer) {
     ...
     */
    public SdlDeliveryListResult getRows(ParameterList params) {
     ...
     */
    @Override
    protected List<SdlDelivery> getExportRows(ParameterList params) {
    ...
    public DhtmlxTableXML init(ParameterList params) throws DhtmlxException {
        if (params.getRowsLoaded() == 0) {
            ...
            SdlDeliveryListResult result = getRows(params);
    ...
    public IHttpResult filter(ParameterList params) throws DhtmlxException {
        ...
        SdlDeliveryListResult result = getRows(rowsloaded, bufferlen);
        clearPlausiErrorData(result.getDeliveries());
        resultSize = result.getMaxNrOfDeliveries();
    ...
    public DhtmlxTableDataXML amend(ParameterList params) throws DhtmlxException {
        ...
        SdlDeliveryResult result = _deliveryService.amendDelivery(getDeliveryId(selected));
    ...
    public DhtmlxTableDataXML replace(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDeliveryResult result = _deliveryService.replaceDelivery(getDeliveryId(selected));
    ...
    public DhtmlxTableDataXML confirm(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDeliveryResult result = _deliveryService.confirmDelivery(getDeliveryId(selected));
    ...
    public DhtmlxTableDataXML cancel(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDeliveryResult result = _deliveryService.cancelDelivery(getDeliveryId(selected));
    ...
    public DhtmlxTableDataXML validate(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDeliveryResult result = _deliveryService.validateDelivery(getDeliveryId(selected), false);
    ...
    public DhtmlxTableDataXML undoValidate(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDeliveryResult result = _deliveryService.validateDelivery(getDeliveryId(selected), true);
    ...
    public DhtmlxTableDataXML createPlausireport(ParameterList params) throws DhtmlxException {
        ...
        SdlDeliveryResult result = _deliveryService.createPlausireport(getDeliveryId(selected));
    ...
    public DhtmlxTableDataXML update(ParameterList params) throws DhtmlxException, OgnlException {
        ...
        SdlDelivery delivery = (SdlDelivery) merge(params);
        PlausiErrorColumn.setPlausiErrorData(delivery.getDeliveryId(), params, this);

        SdlDeliveryResult result = _deliveryService.updateDelivery(delivery, _loadedPlausiErrors.get(delivery.getDeliveryId()));
    ...
    public DhtmlxTableDataXML delete(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDeliveryResult result = _deliveryService.deleteDelivery(getDeliveryId(selected));
    ...
    public DhtmlxTableDataXML refreshStatus(ParameterList params) throws DhtmlxException {
        String selected = params.getRowId();
        SdlDelivery beforeRefresh = (SdlDelivery) getRowData(selected);
        ...
        SdlDeliveryResult result = _deliveryService.refreshStatus(beforeRefresh);
    ...
    protected void clearPlausiErrorData(List<SdlDelivery> deliveries) {
    ...
    public class ReplaceDeliveryData implements Runnable {
        ...
        final SdlDelivery _delivery;

        public ReplaceDeliveryData(SdlDelivery delivery, SecurityContext securityContext) {
            _delivery = delivery;
        ...
        public void run() {
            ...
            try {
                SdlDeliveryResult result = _deliveryService.getDeliveryById(_delivery.getDeliveryId());
                if (result.getState() != ResultBase.OK) {
                    _delivery.setNrPlausiClass("");
                    _delivery.setNrPlausiLearner("");
                    _delivery.setNrPlausiSchool(result.getMessage());
                } else {
                ...
                _delivery.setNrPlausiClass("");
                _delivery.setNrPlausiLearner("");
                _delivery.setNrPlausiSchool("Error");
    ...
    public synchronized IHttpResult replaceData(ParameterList params) throws DhtmlxException {
        String sid = params.getRowId();
        SdlDelivery delivery = (SdlDelivery) getRowData(sid);
        if (delivery.getNrPlausiSchool().equals(MebUtils.getDeliveryToBeLoadedMessage())) {
            delivery.setNrPlausiSchool(ShowReplaceDataCallback.LOADING_KEY);
        ...
        } else if (delivery.getNrPlausiSchool().equals(ShowReplaceDataCallback.LOADING_KEY)) {
            return toReplaceDataResponse(sid, ShowReplaceDataCallback.LOADING_KEY, "", "");
        } else {
            return toReplaceDataResponse(sid, _localizationManager.getMessage(delivery.getNrPlausiSchool(), null, delivery.getNrPlausiSchool()),
                    delivery.getNrPlausiClass(), delivery.getNrPlausiLearner());
        }
    }

    private boolean isReadOnly(SdlDelivery delivery) {
        MebUser user = (MebUser) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    ...
    public Map<String, String> getRowUserData(Object row) {
        HashMap<String, String> userData = new HashMap<String, String>();
        SdlDelivery delivery = (SdlDelivery) row;
        String readOnlyStr;

        // COLUMN_CANTON, COLUMN_VERSION, COLUMN_CODE, COLUMN_STATUS, COLUMN_PLAUSISTATUS
        // COLUMN_DELIVERYDATE, COLUMN_DELIVERYUSER, COLUMN_PLAUSISCHOOL, COLUMN_PLAUSICLASS
        // COLUMN_PLAUSILEARNER

        if (isReadOnly(delivery)) {
            readOnlyStr = "1111111111";
        } else {
            if (delivery.getDeliveryStatus().equals(CodegroupUtility.MEB_DELIVERYSTATUS_PREVALIDATED)
                ...
                readOnlyStr = "1110011111";
            } else {
                readOnlyStr = "1111011111";
            }
        }
    ...
    protected String getRowStyleClass(Object row) {
        SdlDelivery sdlDelivery = (SdlDelivery) row;

        if (sdlDelivery.getDeliveryStatus() == null) {
            return ROW_NOT_VALID_STYLE;
        } else if (sdlDelivery.getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_FINALIZED) {
            return ROW_FINALIZED_STYLE;
        } else if (sdlDelivery.getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_VALIDATED) {
            return ROW_VALIDATED_STYLE;
        } else if (sdlDelivery.getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_PREVALIDATED) {
            return ROW_PREVALIDATED_STYLE;
        } else if (sdlDelivery.getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_DELIVERED) {
            if (sdlDelivery.getPlausiStatus() >= CodegroupUtility.MEB_PLAUSISTATUS_VALID) {
                return ROW_VALID_STYLE;
            } else {
                return ROW_NOT_VALID_STYLE;
            }
        } else if (sdlDelivery.getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_IMPORTED) {
            return ROW_DELIVERY_IMPORTED_STYLE;
        } else if (sdlDelivery.getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_INITIALIZED) {
