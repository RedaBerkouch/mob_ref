...
@Scope("session")
@Component("configDeliveryFilterTableManager")
public class ConfigDeliveryFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(ConfigDeliveryFilterTableManager.class);

    public static final String MANAGER_NAME = "configDeliveryFilter";
    ...
    public WebFilterListResult getAllRows() {
        ...
        return _filterService.getFiltersForRefObject(CodegroupUtility.SDL_OBJECTTYPE_CONFIGDELIVERY);
    }
}
