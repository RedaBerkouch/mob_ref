...
/**
 * Extracts a list of SdlSchools from SdlSchoolListResult
 * 
 * @author $Author: jfu $
 * @version $Revision: 305 $
 */
public class SchoolListTableResultMapper extends ListResultMapperBase {

    /**
     * @param result
     * @throws DhtmlxException
     */
    public SchoolListTableResultMapper(SdlSchoolListResult result, IWebLocalizationManager languageManager, Long resultSize, Integer position)
            throws DhtmlxException {
        super(result, languageManager, resultSize != null ? resultSize.intValue() : null, position);
    }

    @Override
    public List<SdlSchool> getData() {
        return ((SdlSchoolListResult) getResult()).getSchools();
    }
}