...
/**
 * Refresh callback to enable/disable the school table buttons
 * 
 * @author $Author: jfu $
 * @version $Revision: 305 $
 */
public class RefreshSchoolButtonsCallback extends CallbackBase {
    ...
    public RefreshSchoolButtonsCallback(IDhtmlxManager manager, String stateColumnId) {
