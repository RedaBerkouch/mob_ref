...
/**
 * Refresh callback to enable/disable the learner table buttons
 * 
 * @author $Author: jfu $
 * @version $Revision: 305 $
 */
public class RefreshLearnerButtonsCallback extends CallbackBase {
    ...
    public RefreshLearnerButtonsCallback(IDhtmlxManager manager, IDhtmlxControl parentTable, String stateColumnId, String parentStateColumnId) {
