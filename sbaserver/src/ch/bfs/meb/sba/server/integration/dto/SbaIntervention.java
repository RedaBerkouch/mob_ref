...
public class SbaIntervention extends Intervention {
    ...
    /** Default constructor */
    public SbaIntervention() {}

    /** Copy from dto */
    public SbaIntervention(Intervention dtoIntervention) {
