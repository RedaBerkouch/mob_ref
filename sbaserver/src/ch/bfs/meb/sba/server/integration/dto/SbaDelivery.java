...
public class SbaDelivery {
    ...
    // Transient
    private Long _personPlausiOk;
    private Long _personPlausiNotOk;
    private Long _qualificationPlausiOk;
    private Long _qualificationPlausiTotal;
    ...
    public SbaDelivery(SbaDelivery delivery, List<SbaPlausiError> plausiErrors) {
    ...
    public void clearDeliveryNumbers() {
        _personPlausiOk = null;
        _personPlausiNotOk = null;
        _qualificationPlausiOk = null;
        _qualificationPlausiTotal = null;
    }

    public void resetDeliveryNumbers() {
        _personPlausiOk = 0L;
        _personPlausiNotOk = 0L;
        _qualificationPlausiOk = 0L;
        _qualificationPlausiTotal = 0L;
    }
    ...
    public void addPlausiPersons(Long plausiStatus, Long status, Long nrPersons) {
        if ((plausiStatus != null)
            ...
            _personPlausiOk += nrPersons;
        } else {
            _personPlausiNotOk += nrPersons;
        }
    }

    public void addPlausiQualifications(Long plausiStatus, Long nrQualifications) {
        if ((plausiStatus != null)
                && (plausiStatus.equals(CodegroupUtility.MEB_PLAUSISTATUS_VALID) || plausiStatus.equals(CodegroupUtility.MEB_PLAUSISTATUS_CONFIRMED))) {
            _qualificationPlausiOk += nrQualifications;
        } else {
            _qualificationPlausiTotal += nrQualifications;
        }
    }
    ...
    @Where(clause = "personId is null and isToDelete=0")
    ...
    /**
     * @return the string for the person numbers
     */
    @Transient
    public String getNrPlausiPerson() {
        if (_personPlausiOk == null || _personPlausiNotOk == null) {
            return MebUtils.getDeliveryToBeLoadedMessage();
        } else if (getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_IMPORTED && (_personPlausiOk + _personPlausiNotOk == 0L)) {
            // sobald erste person eingelesen --> wird verarbeitet, ansonsten delivery noch in queue
            return MebUtils.getDeliveryQueuedMessage();
        }
        return _personPlausiOk + "/" + new Long(_personPlausiOk + _personPlausiNotOk);
    }

    /**
     * @param dummy
     */
    public void setNrPlausiPerson(String dummy) {}

    /**
     * @return the string for the qualification numbers
     */
    @Transient
    public String getNrPlausiQualification() {
        if (_qualificationPlausiOk == null || _qualificationPlausiTotal == null) {
            return MebUtils.getDeliveryToBeLoadedMessage();
        } else if (getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_IMPORTED && (_personPlausiOk + _personPlausiNotOk == 0L)) {
            // sobald erste person eingelesen --> wird verarbeitet, ansonsten delivery noch in queue
            return "";
        }
        return _qualificationPlausiOk + "/" + _qualificationPlausiTotal;
    }

    /**
     * @param dummy
     */
    public void setNrPlausiQualification(String dummy) {}
