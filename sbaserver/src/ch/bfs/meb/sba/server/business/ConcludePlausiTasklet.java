...
/**
 * Execute all necessary actions to conclude an Sba delivery
 * 
 * @author $Author: lsc $
...
public class ConcludePlausiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution arg0, ChunkContext arg1) throws Exception {
        ...
        ExternalPlausiProcess externalPlausiProcess = _plausiFactory.createExternalPlausiProcess(CodegroupUtility.SBA_OBJECTTYPE_DELIVERY,
                delivery.getVersion());
        ...
        SbaIntervention intervention = _interventionRepository.getInterventionById(_interventionId);
