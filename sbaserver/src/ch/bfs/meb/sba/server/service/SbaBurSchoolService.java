...
@WebService(serviceName = "SbaBurSchoolWebService", name = "SbaBurSchoolWebServicePortType")
public class SbaBurSchoolService extends AbstractMebWebService<IBurSchoolService> {
    @WebMethod
