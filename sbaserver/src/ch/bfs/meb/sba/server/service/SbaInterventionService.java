...
@WebService(serviceName = "SbaInterventionWebService", name = "SbaInterventionWebServicePortType")
public class SbaInterventionService extends AbstractMebWebService<IInterventionService> {
    @WebMethod
