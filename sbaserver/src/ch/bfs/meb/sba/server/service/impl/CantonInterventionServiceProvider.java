...
import ch.bfs.meb.sba.server.integration.repository.ICantonInterventionRepository;
...
public class CantonInterventionServiceProvider implements ICantonInterventionServiceProvider {
    ...
    public CantonIntervention insertIntervention(CantonIntervention intervention) {
        return _interventionRepository.insertIntervention(new SbaCantonIntervention(intervention));
    }

    @Override
    public CantonIntervention updateIntervention(CantonIntervention intervention) {
        return _interventionRepository.updateIntervention(new SbaCantonIntervention(intervention));
    }

    @Override
    public void deleteIntervention(CantonIntervention intervention) {
        _interventionRepository.deleteIntervention(new SbaCantonIntervention(intervention));
    }
}
