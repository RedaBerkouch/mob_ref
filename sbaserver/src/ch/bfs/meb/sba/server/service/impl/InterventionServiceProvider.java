...
public class InterventionServiceProvider implements IInterventionServiceProvider {
    ...
    public Intervention insertIntervention(Intervention intervention) {
        return _interventionRepository.insertIntervention(new SbaIntervention(intervention));
    }

    @Override
    public Intervention updateIntervention(Intervention intervention) {
        return _interventionRepository.updateIntervention(new SbaIntervention(intervention));
    }

    @Override
    public void deleteIntervention(Intervention intervention) {
        _interventionRepository.deleteIntervention(new SbaIntervention(intervention));
    }
}
