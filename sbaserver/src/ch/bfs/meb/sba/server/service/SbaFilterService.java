/*
  ...
  $Id: SbaFilterService.java 590 2010-02-02 12:33:53Z jfu $
 */
...
@WebService(serviceName = "SbaFilterWebService", name = "SbaFilterWebServicePortType")
public class SbaFilterService extends AbstractMebWebService<IFilterService> {
    @WebMethod
