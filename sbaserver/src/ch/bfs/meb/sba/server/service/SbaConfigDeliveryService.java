...
@WebService(serviceName = "SbaConfigDeliveryWebService", name = "SbaConfigDeliveryWebServicePortType")
public class SbaConfigDeliveryService extends AbstractMebWebService<IConfigDeliveryService> {
    @WebMethod
    ...
    @WebMethod
    @PreAuthorize("hasAuthority('" + SecurityConstants.ROLE_SBA_EV + "')")
