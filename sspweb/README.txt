...
Erfolgskontrolle
----------------
SSP kann ohne Fehlermeldung in der richtigen Version (siehe oben) aufgestartet werden.
...
PROPERTIES: Aufstartparameter SSPWEB_PROPERTIES_LOCATION=<path> (Beispiel: file:///data/wls/application.properties)
...
configuration.sspserverurl=<SSP Server> (Beispiel: http://localhost:7001/sspserver)
configuration.commonserverurl=<MEB Server> (Beispiel: http://localhost:7001/mebserver)

Servicelayer
------------
EAR-FILE: sspserverEAR

LOGGING: Aufstartparameter MEB_LOGGING_BASE_DIR=<path> (Beispiel: /logs oder c:\logs)
PROPERTIES: Aufstartparameter SSPSERVER_PROPERTIES_LOCATION=<path> (Beispiel: file:///data/wls/application.properties)
...
SspActivityWebService.wsdl
SspBurSchoolWebService.wsdl
SspCantonWebService.wsdl
SspConfigDeliveryWebService.wsdl
SspDeliveryWebService.wsdl
SspExportWebService.wsdl
SspFilterWebService.wsdl
SspInterventionWebService.wsdl
SspParameterWebService.wsdl
SspPersonWebService.wsdl
SspPlausiWebService.wsdl
SspUploadWebService.wsdl 					: MTOM
SspWizardWebService.wsdl