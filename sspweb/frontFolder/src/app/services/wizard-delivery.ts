...
export class WizardDeliveryService {
	private readonly baseUrl = '/sspweb/api/wizard/delivery';
	...
	loadConfirmableErrors(): Observable<ConfirmableError[]> {
		return this.http.get<ConfirmableError[]>('/sspweb/api/wizard/delivery/errors/confirmable');
	}
	...
	loadAllPlausiErrors(): Observable<ConfirmableError[]> {
		return this.http.get<ConfirmableError[]>('/sspweb/api/wizard/delivery/errors');
	}
