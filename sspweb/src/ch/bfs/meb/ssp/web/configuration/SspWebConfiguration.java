 ...
 */
@ManagedResource(objectName = "ch.bfs.meb:name=sspWebConfiguration", description = "Configuration for SSP web")
public class SspWebConfiguration extends ConfigurationBase implements ISspWebConfiguration {
    public SspWebConfiguration(Resource resource) {
        super(resource);
    }
    ...
    @Override
    @ManagedAttribute(description = "SSP webservices server url")
    public String getModuleServerURL() {
        return getAttribute(SSP_SERVER_URL);
    }
    ...
    @Override
    @ManagedAttribute(description = "Sets the SSP webservices server url")
    public void setModuleServerURL(String url) {
        setAttribute(SSP_SERVER_URL, url);
    }
