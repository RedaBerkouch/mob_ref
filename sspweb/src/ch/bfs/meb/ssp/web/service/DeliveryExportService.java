...
public class DeliveryExportService {
    ...
    private static final String COLUMN_CANTON_NAME_KEY = "deliveryTable.column.canton.name";
    private static final String COLUMN_VERSION_NAME_KEY = "deliveryTable.column.version.name";
    private static final String COLUMN_CODE_NAME_KEY = "deliveryTable.column.deliveryid.name";
    private static final String COLUMN_PLAUSISTATUS_NAME_KEY = "deliveryTable.column.plausistatus.name";
    private static final String COLUMN_STATUS_NAME_KEY = "deliveryTable.column.status.name";
    private static final String COLUMN_DELIVERYDATE_NAME_KEY = "deliveryTable.column.deliverydate.name";
    private static final String COLUMN_DELIVERYUSER_NAME_KEY = "deliveryTable.column.deliveryuser.name";
    private static final String COLUMN_PLAUSIPERSON_NAME_KEY = "deliveryTable.column.plausiperson.name";
    private static final String COLUMN_PLAUSIACTIVITY_NAME_KEY = "deliveryTable.column.plausiactivity.name";
    ...
    private String getColumnHeaders() {
        return new CsvExportRow()
                ...
                .add(localizationManager.getMessage(COLUMN_PLAUSIACTIVITY_NAME_KEY))
                .getRow();
    }

    private String formatDeliveryRow(SspDelivery delivery) {
        return new CsvExportRow()
                ...
                .add(localizationManager.getMessage(delivery.getNrPlausiActivity()))
                .getRow();
    }
}