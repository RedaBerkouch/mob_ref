...
import ch.bfs.meb.ssp.web.frontend.resultmapper.WizardSchoolListTableResultMapper;
...
public class WizardDeliveryTableManager extends TableManagerBase {
    ...
    private static final String COLUMN_NR_OF_ACTIVITIES_ID = "nrOfActivities";
    private static final String COLUMN_NR_OF_ACTIVITIES_NAME_KEY = "wizardDeliveryTable.column.nrOfActivities.name";
    private static final String COLUMN_NR_OF_ACTIVITIES_TEXT_KEY = "wizardDeliveryTable.column.nrOfActivities.text";
    ...
    public void create() throws DhtmlxException {
        ...
        _version = FilterContextUtility.getActVersion(_filterService, CodegroupUtility.SSP_OBJECTTYPE_CONFIGURATION);
        ...
        addColumn(new WizardImageColumn(COLUMN_ICON_ID, COLUMN_ICON_NAME_KEY, COLUMN_NR_OF_ACTIVITIES_ID, getLocalizationManager(), 5));
        ...
        _nrOfColumn = new WizardNrOfColumn(COLUMN_NR_OF_ACTIVITIES_ID, COLUMN_NR_OF_ACTIVITIES_NAME_KEY, COLUMN_NR_OF_ACTIVITIES_TEXT_KEY,
     ...
     */
    public SspWizardSchoolListResult getRows() {
        _allSchoolsDelivered = true;
        SspWizardSchoolListResult schools = _wizardService.getSchools(_dlUser, _version);
     ...
     */
    @Override
    protected List<SspWizardSchool> getExportRows(ParameterList params) {
    ...
    protected DhtmlxTableXML toEmptyXMLStream(boolean ok, String message) throws DhtmlxException {
        SspWizardSchoolListResult result = new SspWizardSchoolListResult();
    ...
    public DhtmlxTableXML delete(ParameterList params) throws DhtmlxException {
        SspDeliveryListResult result = _wizardService.deleteDeliveries(_dlUser, _version);
    ...
    public DhtmlxTableXML validate(ParameterList params) throws DhtmlxException {
        SspDeliveryListResult result = _wizardService.validateDeliveries(_dlUser, _version, getLocalizationManager().getLanguage());
    ...
    public int getNrOfErrors(boolean confirmable) {
        ...
        if (_plausiErrors != null && _plausiErrors.getPlausiErrors() != null) {
            for (SspPlausiError plausiError : _plausiErrors.getPlausiErrors()) {
