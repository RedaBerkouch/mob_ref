...
public class PersonWhereTableManager extends WhereTableManagerBase {
    ...
    protected void addAttributeColumn(TableManagerBase target) throws DhtmlxException {
        ...
        combo.addComboItem(new Long(target.getColumnIndexById(PersonTableManager.COLUMN_NATIONALITY_ID)), PersonTableManager.COLUMN_NATIONALITY_NAME_KEY);
        combo.addComboItem(new Long(target.getColumnIndexById(PersonTableManager.COLUMN_YEARSOFSERVICE_ID)), PersonTableManager.COLUMN_YEARSOFSERVICE_NAME_KEY);
