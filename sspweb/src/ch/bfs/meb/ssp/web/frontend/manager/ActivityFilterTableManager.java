...
@Scope("session")
@Component("activityFilterTableManager")
public class ActivityFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(ActivityFilterTableManager.class);

    public static final String MANAGER_NAME = "activityFilter";
    ...
    public WebFilterListResult getAllRows() {
        ...
        return _filterService.getFiltersForRefObject(CodegroupUtility.SSP_OBJECTTYPE_ACTIVITY);
    }
}
