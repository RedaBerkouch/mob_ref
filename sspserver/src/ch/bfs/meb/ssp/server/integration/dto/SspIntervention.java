...
public class SspIntervention extends Intervention {
    ...
    /** Default constructor */
    public SspIntervention() {}

    /** Copy from dto */
    public SspIntervention(Intervention dtoIntervention) {
