...
public class SspDelivery {
    ...
    private Long _activityPlausiOk;
    private Long _activityPlausiTotal;
    ...
    public SspDelivery(SspDelivery delivery, List<SspPlausiError> plausiErrors) {
    ...
    public void clearDeliveryNumbers() {
        ...
        _activityPlausiOk = null;
        _activityPlausiTotal = null;
    }

    public void resetDeliveryNumbers() {
        _personPlausiOk = 0L;
        _personPlausiNotOk = 0L;
        _activityPlausiOk = 0L;
        _activityPlausiTotal = 0L;
    }
    ...
    public void addPlausiActivities(Long plausiStatus, Long nrActivities) {
        if ((plausiStatus != null)
                && (plausiStatus.equals(CodegroupUtility.MEB_PLAUSISTATUS_VALID) || plausiStatus.equals(CodegroupUtility.MEB_PLAUSISTATUS_CONFIRMED))) {
            _activityPlausiOk += nrActivities;
        } else {
            _activityPlausiTotal += nrActivities;
        }
    }
    ...
    /**
     * @return the string for the activity numbers
     */
    @Transient
    public String getNrPlausiActivity() {
        if (_activityPlausiOk == null || _activityPlausiTotal == null) {
            return MebUtils.getDeliveryToBeLoadedMessage();
        } else if (getDeliveryStatus() == CodegroupUtility.MEB_DELIVERYSTATUS_IMPORTED && (_personPlausiOk + _personPlausiNotOk == 0L)) {
            // sobald erste person eingelesen --> wird verarbeitet, ansonsten delivery noch in queue
            return "";
        }
        return _activityPlausiOk + "/" + _activityPlausiTotal;
    }

    /**
     * @param dummy
     */
    public void setNrPlausiActivity(String dummy) {}
