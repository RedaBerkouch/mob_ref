 ...
 */
@Entity
@Table(name = "SSP_CANTONINTERVENTIONS")
...
public class SspCantonIntervention extends CantonIntervention {
    private Blob plausireportDe;
    private Blob plausireportFr;
    private Blob plausireportIt;

    /** Default constructor */
    public SspCantonIntervention() {}

    /** Copy from dto */
    public SspCantonIntervention(CantonIntervention dtoIntervention) {
