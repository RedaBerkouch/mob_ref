...
@WebService(serviceName = "SspParameterWebService", name = "SspParameterWebServicePortType")
public class SspParameterService extends AbstractMebWebService<IParameterService> {
    @WebMethod
