...
/**
 * Business object for handling Ssp cantons.
 * 
 * @author $Author: dzw $
...
public class CantonBO extends BOBase {
    ...
    private final SspCanton _thisCanton;
     ...
     */
    public CantonBO(SspCanton canton) {
        _thisCanton = canton;
        _confirmRules = canton.getConfirmRules();

        for (SspPlausiError plausierror : canton.getPlausierrors()) {
     ...
     */
    public SspCanton getThisCanton() {
        return _thisCanton;
    }
}
