...
public class PrevalidationMail extends SspMailBase {
    ...
    public String getSubject() {
        return _cantonText + ": SSP-Prevalidation Confirmation";
    }
    ...
    public String getMailBody() {
        ...
        return new MailTemplate(_mailMessage, MailTemplate.TEMPLATE_RESOURCE_LOCATION_SSP, new Locale(_locale), new MailParameter()).parse();
    }
}
