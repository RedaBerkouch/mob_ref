...
Erfolgskontrolle
----------------
SBA kann ohne Fehlermeldung in der richtigen Version (siehe oben) aufgestartet werden.
...
PROPERTIES: Aufstartparameter SBAWEB_PROPERTIES_LOCATION=<path> (Beispiel: file:///data/wls/application.properties)
...
configuration.sbaserverurl=<SBA Server> (Beispiel: http://localhost:7001/sbaserver)
configuration.commonserverurl=<MEB Server> (Beispiel: http://localhost:7001/mebserver)

Servicelayer
------------
EAR-FILE: sbaserverEAR

LOGGING: Aufstartparameter MEB_LOGGING_BASE_DIR=<path> (Beispiel: /logs oder c:\logs)
PROPERTIES: Aufstartparameter SBASERVER_PROPERTIES_LOCATION=<path> (Beispiel: file:///data/wls/application.properties)
...
SbaQualificationWebService.wsdl
SbaBurSchoolWebService.wsdl
SbaCantonWebService.wsdl
SbaConfigDeliveryWebService.wsdl
SbaDeliveryWebService.wsdl
SbaExportWebService.wsdl
SbaFilterWebService.wsdl
SbaInterventionWebService.wsdl
SbaParameterWebService.wsdl
SbaPersonWebService.wsdl
SbaPlausiWebService.wsdl
SbaUploadWebService.wsdl 					: MTOM
SbaWizardWebService.wsdl