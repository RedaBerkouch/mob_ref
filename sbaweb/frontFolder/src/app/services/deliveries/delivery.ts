...
export class DeliveryService {
	private readonly baseUrl = '/sbaweb/api/deliveries';
	...
	private formatDelivery(delivery: Delivery): Delivery {
		return {
			...
			nrPlausiQualification: this.translateLoadingState(delivery.nrPlausiQualification)
		};
	}
	...
	private needsPolling(delivery: Delivery): boolean {
		return this.LOADING_STATES.includes(delivery.nrPlausiPerson as any)
			|| this.LOADING_STATES.includes(delivery.nrPlausiQualification as any);
	}
