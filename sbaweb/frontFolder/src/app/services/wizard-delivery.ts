...
export class WizardDeliveryService {
	private readonly baseUrl = '/sbaweb/api/wizard/delivery';
	...
	loadConfirmableErrors(): Observable<ConfirmableError[]> {
		return this.http.get<ConfirmableError[]>('/sbaweb/api/wizard/delivery/errors/confirmable');
	}
	...
	loadAllPlausiErrors(): Observable<ConfirmableError[]> {
		return this.http.get<ConfirmableError[]>('/sbaweb/api/wizard/delivery/errors');
	}
