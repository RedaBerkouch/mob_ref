 ...
 *  - elle n'est pas référencée dans le SBA (burIsSba = false), OU
...
export function shouldDeleteOnGetBur(school: School, version: number): boolean {
	return (
		...
		(school.burValidFromSba != null && school.burValidFromSba > version) ||
		(school.burValidToSba != null && school.burValidToSba < version)
	);
}
