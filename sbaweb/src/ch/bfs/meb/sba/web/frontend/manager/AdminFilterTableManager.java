/*
  ...
  $Id: AdminFilterTableManager.java 521 2010-01-25 14:46:35Z msc $
 */
...
import ch.bfs.meb.sba.web.frontend.resultmapper.FilterListTableResultMapper;
import ch.bfs.meb.sba.web.frontend.resultmapper.FilterTableResultMapper;
...
public class AdminFilterTableManager extends TableManagerBase {
    ...
    public void create() throws DhtmlxException {
        ...
        ComboCodeGroupColumn objectColumn = new ComboCodeGroupColumn(COLUMN_OBJECT_ID, COLUMN_OBJECT_NAME_KEY, getLocalizationManager(),
                CodegroupUtility.SBA_OBJECTTYPE, 6);
