...
import ch.bfs.meb.sba.web.frontend.resultmapper.WizardPlausiErrorListTableResultMapper;
import ch.bfs.meb.sba.web.frontend.resultmapper.WizardPlausiErrorTableResultMapper;
...
public class WizardPlausiErrorTableManager extends TableManagerBase {
    ...
    private static final String COLUMN_QUALIFICATIONLABEL_ID = "qualificationLabel";
    private static final String COLUMN_QUALIFICATIONLABEL_NAME_KEY = "wizardPlausiErrorTable.column.qualificationlabel.name";
    ...
    private List<SbaPlausiError> _changedPlausiErrors;
    ...
    public void create() throws DhtmlxException {
        ...
        col = new ReadOnlyColumn(COLUMN_QUALIFICATIONLABEL_ID, COLUMN_QUALIFICATIONLABEL_NAME_KEY, getLocalizationManager(), 16);
        col.setColor(COLOR.WHITE);
        addColumn(col);
    ...
    public void setData(String dlUser, Long version, SbaPlausiErrorListResult plausiErrors) {
        _dlUser = dlUser;
        _version = version;
        _plausiErrors = plausiErrors;
        _changedPlausiErrors = new ArrayList<SbaPlausiError>();
    }

    /**
     * Gets all rows for plausi error Table
     */
    public SbaPlausiErrorListResult getRows() {
     ...
     */
    @Override
    protected List<SbaPlausiError> getExportRows(ParameterList params) {
    ...
    public DhtmlxTableDataXML update(ParameterList params) throws DhtmlxException, OgnlException {
        ...
        SbaPlausiError plausiError = (SbaPlausiError) merge(params);
    ...
    public DhtmlxTableXML confirm(ParameterList params) throws DhtmlxException {
        ...
        if (_changedPlausiErrors.size() > 0) {
            ...
            result = new SbaPlausiErrorListResult();
