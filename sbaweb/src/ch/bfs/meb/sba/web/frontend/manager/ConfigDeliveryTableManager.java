...
import ch.bfs.meb.sba.web.frontend.resultmapper.ConfigDeliveryListTableResultMapper;
import ch.bfs.meb.sba.web.frontend.resultmapper.ConfigDeliveryTableResultMapper;
import ch.bfs.meb.sba.web.service.ICantonService;
import ch.bfs.meb.sba.web.service.IConfigDeliveryService;
...
public class ConfigDeliveryTableManager extends FilteredTableManagerBase {
    ...
    public void create() throws DhtmlxException {
        ...
        setFilterVersion(FilterContextUtility.getInitVersion(_filterService, CodegroupUtility.SBA_OBJECTTYPE_CONFIGURATION));
        ...
        IJavaScriptFunction refreshButtonsCallback = new RefreshConfigDeliveryButtonsCallback(this,  !user.isRoleErhebung(MebDomain.SBA));
