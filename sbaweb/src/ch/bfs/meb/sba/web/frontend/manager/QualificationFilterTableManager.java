...
@Scope("session")
@Component("qualificationFilterTableManager")
public class QualificationFilterTableManager extends FilterTableManagerBase {
    @SuppressWarnings("unused")
    private static final Log LOGGER = LogFactory.getLog(QualificationFilterTableManager.class);

    public static final String MANAGER_NAME = "qualificationFilter";
    ...
    public WebFilterListResult getAllRows() {
        ...
        return _filterService.getFiltersForRefObject(CodegroupUtility.SBA_OBJECTTYPE_QUALIFICATION);
    }
}
