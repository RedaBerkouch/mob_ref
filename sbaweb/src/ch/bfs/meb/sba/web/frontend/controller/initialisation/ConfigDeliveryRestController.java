...
import ch.bfs.meb.sba.web.frontend.dto.SelectedSearchRequest;
import ch.bfs.meb.sba.web.service.ConfigDeliveryExportService;
...
public class ConfigDeliveryRestController {
    ...
    public ResponseEntity<List<ConfigDelivery>> getAll(@RequestBody SelectedSearchRequest request) {
        ...
        WebFilterContext filterContext =
                webFilterService.filterContextFromSearchRequest(request, CodegroupUtility.SBA_OBJECTTYPE_CONFIGDELIVERY);
    ...
    public ResponseEntity<List<WebFilter>> getFilters() {
        WebFilterListResult result =
                filterService.getFiltersForRefObject(CodegroupUtility.SBA_OBJECTTYPE_CONFIGDELIVERY);
