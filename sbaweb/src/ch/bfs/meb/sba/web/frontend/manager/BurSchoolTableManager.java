...
import ch.bfs.meb.sba.web.frontend.resultmapper.BurSchoolListTableResultMapper;
import ch.bfs.meb.sba.web.frontend.resultmapper.BurSchoolTableResultMapper;
...
public class BurSchoolTableManager extends FilteredTableManagerBase {
    ...
    public void create() throws DhtmlxException {
        ...
        if (!user.isRoleErhebung(MebDomain.SBA)) {
    ...
    public Map<String, String> getRowUserData(Object row) {
        ...
        //TODO CLEANUP (NB AUCH SSP UND SBA)
        ...
        boolean toDelete = !burSchool.isBurIsSba() || burSchool.getBurActivityStatus() == CodegroupUtility.MEB_BUR_ACTIVITY_STATUS_DELETED
                ...
                || (burSchool.getBurValidFromSba() != null && burSchool.getBurValidFromSba() > version)
                || (burSchool.getBurValidToSba() != null && burSchool.getBurValidToSba() < version);
