...
import ch.bfs.meb.sba.web.frontend.resultmapper.CantonListTableResultMapper;
import ch.bfs.meb.sba.web.frontend.resultmapper.CantonTableResultMapper;
...
public class CantonTableManager extends TableManagerBase implements PlausiErrorColumn.IPlausiErrorDataUpdate {
    ...
    public void create() throws DhtmlxException {
        ...
        _version = FilterContextUtility.getInitVersion(_filterService, CodegroupUtility.SBA_OBJECTTYPE_CONFIGURATION);
        ...
        IJavaScriptFunction refreshButtonsCallback = new RefreshCantonButtonsCallback(this, COLUMN_DELIVERYSTATUS_ID, COLUMN_PLAUSIUSER_ID,
                CodegroupUtility.MEB_APPLICATION_SBA);
        ...
        String validateMessage = user.isInRole(SecurityConstants.ROLE_SBA_EV) ? CONFIRM_VALIDATE_MESSAGE : CONFIRM_VALIDATE_DV_MESSAGE;
    ...
    protected List<Long> getMissingCantons() {
        ...
        Collections.sort(missingCantons);
