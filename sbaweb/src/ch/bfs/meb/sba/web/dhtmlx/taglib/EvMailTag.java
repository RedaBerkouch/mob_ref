 ...
 */
package ch.bfs.meb.sba.web.dhtmlx.taglib;
...
public class EvMailTag extends DhtmlxTagBase {
    ...
    public void doTag() throws DhtmlxTagException {
        try {
            ISbaWebConfiguration configuration = (ISbaWebConfiguration) ApplicationContextProvider.getApplicationContext().getBean(ConfigurationBase.BEAN_NAME);
            ...
            pageContext.getOut().print(idmUserService.getEVMailAddresses(CodegroupUtility.MEB_APPLICATION_SBA).get(0));
